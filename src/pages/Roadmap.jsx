  ...
  return (
    <section id="roadmap">
      <div className="roadmap-gradient h-screen pt-12 md:pt-0">
        <div className="flex flex-col container items-center space-y-16 pt-16 mx-auto md:pt-24 2xl:pt-48 md:pb-8 max-w-7xl">
          <MobileTitle title="Roadmap" />
          {/* <h1 className="flex w-full items-center justify-center h-32">
            ROADMAP
          </h1> */}
          <div className="flex h-[500px] md:h-[700px] 3xl:h-[750px] 4xl:h-[850px] scrollbar-style">
