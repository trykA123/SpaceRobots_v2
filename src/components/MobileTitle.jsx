...
const MobileTitle = ({ title }) => {
  return (
    <div className="flex w-48 items-center justify-between md:hidden">
      ...
      <p className="flex items-center justify-center text-white uppercase font-chakraPetch text-xl font-bold">
        {title}
      </p>
