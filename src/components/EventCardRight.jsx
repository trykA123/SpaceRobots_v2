...
const EventCardRight = ({ info, date, openModal }) => {
  const handleClick = () => {
    ...
    <div className="flex w-full justify-start">
      ...
      <div className="flex w-[450px] 3xl:w-[600px] 3xl:h-[200px] items-center space-x-6 justify-between ml-2 p-4 roadmap-gradient rounded-md shadow-md shadow-teal-600">
        ...
        <div className="flex flex-col space-y-6 3xl:w-[400px] w-64">
          <p className="h-20 text-base  leading-4">
          ...
          <div className="flex items-center justify-between">
            <h2 className=" text:lg md:text-xl 3xl:text-3xl font-chakraPetch">
              2023.05.24
            </h2>
            <button
              onClick={handleClick}
              className="flex items-center justify-center  md:w-24 md:h-8 3xl:w-36 3xl:h-12 bg-teal-text-100 rounded-sm upper hover:3xl:w-48 duration-500"
            >
              Explore
            </button>
          </div>
