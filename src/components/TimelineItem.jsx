...
const TimelineItem = ({ status, title, content }) => {
  return (
    <div className="relative mt-3 flex space-y-14 rounded-lg border border-transparent bg-background-color duration-500 hover:border-primary-teal hover:animate-pulse">
